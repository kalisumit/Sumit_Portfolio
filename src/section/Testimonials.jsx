...
const focuses = [
    {
        ...
        description:
            "Building responsive, scalable, and modern user interfaces using React.js and TailwindCSS.",
        icon: "⚛️",
    },
    {
        title: "Performance Optimization",
        description:
            "Creating fast-loading applications with smooth user experiences and optimized rendering.",
        icon: "⚡",
    },
    {
        title: "Full Stack Development",
        description:
            "Expanding backend skills with Node.js, Express.js, MongoDB, and REST APIs.",
        icon: "🚀",
    },
    {
        title: "Continuous Learning",
        description:
            "Exploring modern technologies, system design concepts, and best engineering practices.",
        icon: "📚",
    },
];
      ...
      px-6 relative z-10"
        ...
        mx-auto mb-16"
          ...
          animation-delay-100 text-secondary-foreground"
                    >
                        The principles and technologies that drive how I build modern web applications.{" "}
                        <span
                        ...
                        <div className="glass p-8 rounded-3xl md:p-12 glow-border animate-fade-in animation-delay-200">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center text-2xl">
                                    {focuses[activeIdx].icon}
                                </div>
                                <div>
                                    <div className="font-semibold">
                                        {focuses[activeIdx].title}
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        {/* {focuses[activeIdx].role} */}
                                        Developer Priority
                                    </div>
                                </div>
                            </div>
