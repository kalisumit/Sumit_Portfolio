...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "sumit7314roy@gmail.com",
        href: "mailto:sumitroy7314roy@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+91 8130837919",
        href: "tel:+918130837919",
    },
    {
        icon: MapPin,
        label: "Location",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!serviceId || !templateId || !publicKey) {
                throw new Error(
                    "EmailJS configuration is missing. Please check you environment veriable"
                );
            }
            ...
            setSubmitStatus({
                type: "success",
                message: "Message sent successfully! I'll be get back to you soon."
            });
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    Whether you have a project idea, an internship opportunity, or just want to connect, feel free to send a message. I’m always open to learning, collaborating, and building impactful digital experiences.
                </p>
            </div>
                ...
                <div className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
                    <form className="space-y-6 " onSubmit={handleSubmit}>
                        ...
                        <Button className="w-full" type="submit" size="lg" disabled={isLoading}>
                            {isLoading ? (<span>Sending...</span>) : (<>Send Message<Send className="w-5 h-5" /></>)}
                        </Button>
